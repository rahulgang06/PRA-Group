...
if (isset($_POST['create_repo']))
 ...
 if (empty($name)) {
   ...
   if (preg_match('/[\/\'^£$%&*()}{@#~?><>,|=+¬-]/', $name)) {
     $nameErr = "Invalid name of repository";
     $name = "";
   }
 }
...
$Query="INSERT INTO repo(name,description,pub,username) values(:name,:description,:pub,:user)";
    ...
    //$Stmt->bindValue(':jenkins',$jenkins);
    //$Stmt->bindValue(':yaml',$yaml);
  ...
  <div class="card">
      ...
      <form class="form-a contactForm" action="create_repo.php" method="POST" role="form"> 
                 <div class="col-md-12 mb-3">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      <input type="radio" name="pub" value="0" checked><h6>Public</h6> 
                      <input type="radio" name="pub" value="1"> <h6>Private</h6>
                      </div>
                      </div>
                  <div class="col-md-12">
