...
$data="pipeline {
 ...
 $sha=create_files_data($access_token,$username,$name,$url,$username,$data);
  $data = "
    Metadata:
      Author:".$username."
      Git-repo:".$git_url."
...
header("Location: final.php?html_url=$html_url&name=$name");
}
...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
  ...
  <h3>Create repository using "<?php echo $name;?>" template</h3><br>
         <div class="col-sm-12">
          <div class="row">
            <div class="col-md-7">
      <form class="form-a contactForm" action="get_link.php?repo_id=<?php echo $old_repo_id;?>&name=<?php echo $name;?>" method="POST" role="form"> 
                 <div class="col-md-12 mb-3">
                    <div class="form-group">
                      ...
                      <font color="red" id="nErr"><?php if($nameErr != '') echo $nameErr; ?></font>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="form-group">
                      ...
                      <div class="validation" required="true"></div>
                    </div>
                  </div>
  <!--
                    <div class="col-md-12 mb-3">
...
<br><br>
                    ...
                    <label class="radio-inline">
                      <input type="radio" name="pub" value="0" checked><h4>Public</h4> 
                    </label>
                    <label class="radio-inline"><input type="radio" name="pub" value="1"> <h4>Private</h4></label>
