...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
  ...
  <div class="card">
   ...
   <br><br>
   <table style="margin-right: 300px; align-content: center;">
    <td>
   <form action= 'create_repo.php' method="POST">
   <div class="outer">
   <input type="hidden" name="data" value="<?php echo $access_token; ?>">
   <div class="inner"><input type='submit'  class="btn btn-lg btn-success" name="create_repo_call" value="Create Your Own Template"onClick="google()"></div>
   </div>
   </form>
 </td>
 <td>
   <form action= 'othertemp.php' method="POST" >
      <div class="outer">
      <input type="hidden" name="data" value="<?php echo $access_token; ?>">
      <div class="inner"><input type='submit'  class="btn btn-lg btn-success"  name="use_std_repos" value="Make use of existing templates" onClick="google()"></div>
      </div>
   </form>
   </td>
   <td>
  <form action= 'toggle.php' method="POST">
      <div class="outer">
      <input type="hidden" name="data" value="<?php echo $access_token; ?>">
      <div class="inner"><input type='submit'  class="btn btn-lg btn-success" name="use_std_repos" value="Change configurations of repositories" onClick="google()"></div>
      </div>
   </form>
   </td>
   </table>
