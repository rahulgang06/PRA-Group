...
form.example::after {
  ...
  <div class="card">
   ...
   <button class="btn btn-lg btn-success" onclick="location.href = 'get_link.php?repo_id=<?php echo $repo_id;?>&name=<?php echo $name;?>';" >Get github link</button>
   <button class="btn btn-lg btn-success" onclick="location.href = 'othertemp.php';" >Other Templates</button>
  </div>
    </div>
    </div>
    </div>
